...
description: >
  ...
  should I use'. Never calls the Drata API.
area: Start Here
permission: read-only (no MCP calls — catalog only)
---
...
- **drata-control-identify-gaps** — not-ready controls, each with a root cause and next step.
